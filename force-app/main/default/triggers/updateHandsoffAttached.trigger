trigger updateHandsoffAttached on Top_X_Designation__c (before insert,before update,before delete,after insert,after update,after delete,after undelete)  {
